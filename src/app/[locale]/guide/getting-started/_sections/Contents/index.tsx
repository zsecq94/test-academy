...
export function Contents() {
  ...
  return (
    <section className="relative">
      ...
      <Container>
        <div className="v1920:px-35 v1280:px-30 v1024:py-25 v1280:gap-23 v1024:gap-20 v768:gap-18 v1280:border-b relative flex flex-col gap-15 border-t border-b-0 border-gray-500 py-18">
